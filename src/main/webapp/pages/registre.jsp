...
<%--                                                    alt="logo"--%>
<%--                                            />--%>
                                            <h4 class="text-xl font-semibold mt-1 mb-12 pb-1">CREATE YOUR ACCOUNT</h4>
                                        </div>
                                        <form>
                                            <p class="mb-4">Please enter you informations</p>
                                            <div class="mb-4">
                                                <input
                                                        type="text"
                                            ...
                                            <div class="flex items-center justify-between pb-6">
                                                ...
                                                <button
                                                        type="button"
                                                        class="inline-block px-6 py-2 border-2 border-balck text-balck font-medium text-xs leading-tight uppercase rounded hover:bg-black hover:bg-opacity-5 focus:outline-none focus:ring-0 transition duration-150 ease-in-out"
                                                        data-mdb-ripple="true"
                                                        data-mdb-ripple-color="light"
                                                >
